        ...
        <div className="flex items-center justify-between h-16 gap-1 sm:gap-4">
          ...
          <div className="flex-shrink-0 flex items-center -ml-1 sm:-ml-2">
            <Link to="/" className="flex items-center gap-0.5 sm:gap-1.5">
              ...
              <span className="font-bold text-xs sm:text-xl tracking-tight text-slate-900 whitespace-nowrap">
          ...
          <div className="flex items-center gap-x-1.5 sm:gap-x-2.5 md:gap-x-4">
            ...
            <div className="relative shrink-0" ref={createRef}>
              <button
                ...
                className="flex items-center gap-0.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[11px] sm:text-xs px-1 py-1 sm:px-2.5 sm:py-1.5 rounded-md shadow-sm active:scale-[0.98] transition-all"
              >
